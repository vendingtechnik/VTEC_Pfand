...
$aModule = array (
    'id'           => 'vtec_pfandmodul',
    'title'        => 'VTEC Pfandmodul - automatische Pfandartikel',
    ...
    'thumbnail'    => 'pfand.jpg',
    'version'      => '2.0 - ab CE 4.9.0',
    'author'       => 'Pasquale Pari',
    'url'          => 'http://www.vendingtechnik.com <br \> http://www.getraenkekiste.ch',
    'email'        => 'pasquale.pari@vendingtechnik.com',
    'extend'       => array (
        'oxarticle'     => 'vtec/pfandmodul/vtec_pfand',
        'oxbasketitem'  => 'vtec/pfandmodul/vtec_oxbasketitem',
        'oxbasket'      => 'vtec/pfandmodul/vtec_oxbasket',
        ),
        
     'settings'     => array
    (
        array(
                'group'     => 'vtec_pfand_main',
